...
└── js/
    ...
    ├── core/
    │   ├── Engine.js     # Motor principal. Orquesta Scene, Render Loop, Targeting y Piloto Automático.
    │   └── Config.js     # Única fuente de la verdad para parámetros globales (tuning de físicas, procedural, etc.)
    ├── graphics/
    │   └── LightingManager.js # Gestor de iluminación. Optimiza el rendimiento gestionando la luz dinámica.
    ├── player/
    │   └── SpaceControls.js   # Vuelo espacial, inercia, salto cuántico y cámara cinemática geocéntrica.
    ├── ui/
    │   ├── UIManager.js  # Gestor de interfaz gráfica persistente y etiquetas 3D proyectadas en 2D.
    │   └── OSDManager.js # Motor autónomo para notificaciones on-screen temporales (no apilables).
    ├── utils/
