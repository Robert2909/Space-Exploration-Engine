export const Config = {
    ...
    // ==========================================
    UNIVERSE_CHUNK_SIZE: 1000000000000, // Tamaño de un sector del espacio (u)
    STARS_PER_CHUNK: 600, // Cantidad de estrellas decorativas (puntos) por sector
    SYSTEM_SPAWN_CHANCE: 0.5, // Probabilidad (0.0 a 1.0) de que aparezcan planetas en un sector vacío
    MAX_SYSTEMS_PER_CHUNK: 10, // Número máximo de sistemas solares por sector
    BINARY_STAR_CHANCE: 0.05, // Probabilidad de que un sistema sea binario
    BINARY_STAR_DISTANCE_BASE_MULT: 30.0, // Multiplicador del radio del sol primario para separar la estrella binaria
    BINARY_STAR_DISTANCE_VAR_MULT: 40.0, // Variación aleatoria de la distancia de la estrella binaria
    ...
    // ESCALA FÍSICA REALISTA (1 unidad = 10 km aprox)
    // Para lograr temperaturas reales (Zonas: Caliente -> Habitable -> Fría -> Congelada)
    ORBIT_DISTANCE_START: 3000000, // Distancia mínima devuelta a 30M km (Zona mercuriana/Volcánica)
    ORBIT_DISTANCE_SPACING: 15000000, // Salto reducido a 150M km para no saltarse la zona habitable
    ORBIT_DISTANCE_VAR: 10000000, // Variación de 100M km para crear sistemas densos o dispersos
    HELIOPAUSE_PADDING: 150000000, // Frontera enorme después del último planeta

    // ASTEROIDES
    ASTEROID_MIN_ORBIT: 25000000, // Cinturón interior (250M km, tipo Cinturón Principal)
    ASTEROID_MAX_ORBIT: 90000000, // Cinturón exterior (900M km, más allá de los gigantes)

    // ==========================================
    // TIPOS DE ESTRELLAS (DICCIONARIO MAESTRO)
    // ==========================================
    STAR_TYPES: {
        'Gigante azul': { chance: 0.05, hueBase: 0.55, hueVar: 0.1, sat: 0.8, litBase: 0.7, litVar: 0.2, radiusMultMin: 1.5, radiusMultMax: 3.0, tempBase: 10000, tempVar: 30000 },
        'Supergigante roja': { chance: 0.02, hueBase: 0.02, hueVar: 0.05, sat: 0.9, litBase: 0.5, litVar: 0.2, radiusMultMin: 8.0, radiusMultMax: 20.0, tempBase: 3000, tempVar: 1000 },
        'Enana blanca': { chance: 0.05, hueBase: 0.6, hueVar: 0.1, sat: 0.1, litBase: 0.9, litVar: 0.1, radiusMultMin: 0.05, radiusMultMax: 0.1, tempBase: 15000, tempVar: 50000 },
        'Estrella de neutrones': { chance: 0.01, hueBase: 0.7, hueVar: 0.2, sat: 0.3, litBase: 0.9, litVar: 0.1, radiusMultMin: 0.005, radiusMultMax: 0.01, tempBase: 100000, tempVar: 500000 },
        'Enana amarilla': { chance: 0.30, hueBase: 0.12, hueVar: 0.05, sat: 0.7, litBase: 0.6, litVar: 0.2, radiusMultMin: 0.8, radiusMultMax: 1.2, tempBase: 5000, tempVar: 1500 },
        'Enana naranja': { chance: 0.25, hueBase: 0.08, hueVar: 0.04, sat: 0.8, litBase: 0.5, litVar: 0.2, radiusMultMin: 0.5, radiusMultMax: 0.9, tempBase: 3500, tempVar: 1500 },
        'Enana roja': { chance: 0.20, hueBase: 0.0, hueVar: 0.05, sat: 0.8, litBase: 0.4, litVar: 0.2, radiusMultMin: 0.2, radiusMultMax: 0.5, tempBase: 2000, tempVar: 1500 },
        'Enana marrón': { chance: 0.12, hueBase: 0.05, hueVar: 0.02, sat: 0.6, litBase: 0.2, litVar: 0.1, radiusMultMin: 0.1, radiusMultMax: 0.2, tempBase: 800, tempVar: 1000 }
    },
    SUN_GLOW_SCALE: 4, // Tamaño del halo de luz visual de las estrellas (1.0 = igual al planeta)
    ...
    PLANET_BIOMES: {
        // === GIGANTES GASEOSOS ===
        'Gigante gaseoso': { chance: 0.06, isGasGiant: true, hueBase: 0.05, hueVar: 0.10, sat: 0.7, lit: 0.5, warpBase: 4.0, warpVar: 3.0, stretchBase: 3.0, stretchVar: 5.0, radiusMult: 1.0, ringChance: 0.80, albedo: 0.5, greenhouse: 2, tempMin: 50, tempMax: 400 },
        'Gigante helado': { chance: 0.03, isGasGiant: true, hueBase: 0.55, hueVar: 0.10, sat: 0.6, lit: 0.6, warpBase: 2.0, warpVar: 2.0, stretchBase: 1.5, stretchVar: 2.0, radiusMult: 0.8, ringChance: 0.90, albedo: 0.6, greenhouse: 0.5, tempMin: 0, tempMax: 150 },
        'Gigante de amoníaco': { chance: 0.04, isGasGiant: true, hueBase: 0.15, hueVar: 0.05, sat: 0.8, lit: 0.60, warpBase: 3.0, warpVar: 2.0, stretchBase: 4.0, stretchVar: 4.0, radiusMult: 1.2, ringChance: 0.40, albedo: 0.5, greenhouse: 1.5, tempMin: 100, tempMax: 250 },
        'Gigante de silicato': { chance: 0.04, isGasGiant: true, hueBase: 0.05, hueVar: 0.02, sat: 0.1, lit: 0.70, warpBase: 5.0, warpVar: 3.0, stretchBase: 5.0, stretchVar: 6.0, radiusMult: 1.1, ringChance: 0.60, albedo: 0.3, greenhouse: 3, tempMin: 800, tempMax: 9999 },
        'Júpiter caliente': { chance: 0.02, isGasGiant: true, hueBase: 0.02, hueVar: 0.05, sat: 0.8, lit: 0.3, warpBase: 6.0, warpVar: 4.0, stretchBase: 2.0, stretchVar: 2.0, radiusMult: 1.5, ringChance: 0.10, albedo: 0.1, greenhouse: 2.5, tempMin: 600, tempMax: 3000 },

        // === MUNDOS CON OCÉANOS / HABITABLES ===
        'Planeta oceánico': { chance: 0.03, atmoBase: 0.0003, atmoVar: 0.0002, hueBase: 0.55, hueVar: 0.10, sat: 0.8, lit: 0.30, terrainMods: { octavesAdd: -1, exponentMult: 0.8, heightMult: 0.4 }, aesthetics: { waterLevel: 0, waterColor: 0x1144aa, beachColor: 0xddccaa, beachBlend: 0.6 }, warpBase: 1.0, warpVar: 1.5, radiusMult: 1.05, ringChance: 0.05, albedo: 0.2, greenhouse: 1.2, tempMin: 250, tempMax: 330 },
        'Mundo edénico': { chance: 0.03, atmoBase: 0.0002, atmoVar: 0.0002, hueBase: 0.35, hueVar: 0.10, sat: 0.7, lit: 0.25, terrainMods: { octavesAdd: 1, exponentMult: 1.1, heightMult: 1.2 }, aesthetics: { hasSand: true, sandColor: 0xddbb55, hasSnow: true }, warpBase: 1.2, warpVar: 1.2, radiusMult: 1.0, ringChance: 0.02, albedo: 0.3, greenhouse: 1.3, tempMin: 260, tempMax: 340 },
        'Planeta prístino': { chance: 0.02, atmoBase: 0.0002, atmoVar: 0.0001, hueBase: 0.30, hueVar: 0.05, sat: 0.8, lit: 0.40, terrainMods: { octavesAdd: 0, exponentMult: 1.0, heightMult: 1.0 }, aesthetics: { hasSand: true, sandColor: 0xffeeaa, hasSnow: true, waterLevel: 0, waterColor: 0x2288ff }, warpBase: 1.0, warpVar: 1.0, radiusMult: 1.0, ringChance: 0.0, albedo: 0.3, greenhouse: 1.1, tempMin: 240, tempMax: 320 },
        'Planeta abisal': { chance: 0.02, atmoBase: 0.0003, atmoVar: 0.0001, hueBase: 0.60, hueVar: 0.10, sat: 0.2, lit: 0.10, terrainMods: { octavesAdd: -1, exponentMult: 0.9, heightMult: 0.5 }, aesthetics: { waterLevel: 100, waterColor: 0x050510 }, warpBase: 1.5, warpVar: 1.0, radiusMult: 1.1, ringChance: 0.02, albedo: 0.1, greenhouse: 1.5, tempMin: 230, tempMax: 310 },

        // === MUNDOS CALIENTES / INFERNALES ===
        'Planeta de lava': { chance: 0.03, atmoBase: 0.0004, atmoVar: 0.0000, hueBase: 0.00, hueVar: 0.10, sat: 0.9, lit: 0.40, terrainMods: { octavesAdd: 1, exponentMult: 1.3, heightMult: 1.5 }, aesthetics: { crackLevel: -100, crackColor: 0xff3300, baseLerpColor: 0x1a1a1a, baseLerp: 0.9 }, warpBase: 2.0, warpVar: 2.0, radiusMult: 0.95, ringChance: 0.10, albedo: 0.1, greenhouse: 1.5, tempMin: 600, tempMax: 9999 },
        'Mundo carbonizado': { chance: 0.02, atmoBase: 0.0001, atmoVar: 0.0000, hueBase: 0.00, hueVar: 0.00, sat: 0.0, lit: 0.15, terrainMods: { octavesAdd: 1, exponentMult: 0.8, heightMult: 0.5 }, aesthetics: { hasSand: false, hasSnow: false }, warpBase: 1.0, warpVar: 0.5, radiusMult: 0.9, ringChance: 0.08, albedo: 0.05, greenhouse: 0.5, tempMin: 400, tempMax: 1500 },
        'Mundo fracturado': { chance: 0.04, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.05, hueVar: 0.10, sat: 0.2, lit: 0.30, terrainMods: { octavesAdd: 1, exponentMult: 2.5, heightMult: 2.5 }, aesthetics: { hasSand: false, hasSnow: false, crackLevel: -20, crackColor: 0xffaa00, baseLerpColor: 0x111111, baseLerp: 0.9 }, warpBase: 2.0, warpVar: 2.0, radiusMult: 0.85, ringChance: 0.15, albedo: 0.15, greenhouse: 0.2, tempMin: 500, tempMax: 1800 },

        // === MUNDOS HELADOS / CRISTALINOS ===
        'Mundo glaciar': { chance: 0.03, atmoBase: 0.0001, atmoVar: 0.0002, hueBase: 0.50, hueVar: 0.10, sat: 0.4, lit: 0.80, terrainMods: { octavesAdd: -1, exponentMult: 0.7, heightMult: 0.6 }, aesthetics: { globalLerpColor: 0xffffff, globalLerpBase: 0.5, globalLerpLat: 0.5 }, warpBase: 0.5, warpVar: 1.0, radiusMult: 0.9, ringChance: 0.05, albedo: 0.7, greenhouse: 0.1, tempMin: 0, tempMax: 250 },
        'Desierto alcalino': { chance: 0.03, atmoBase: 0.0001, atmoVar: 0.0000, hueBase: 0.0, hueVar: 0.0, sat: 0.0, lit: 0.90, terrainMods: { octavesAdd: -1, exponentMult: 0.6, heightMult: 0.2 }, aesthetics: { hasSand: true, sandColor: 0xffffff, hasSnow: false }, warpBase: 1.0, warpVar: 1.0, radiusMult: 1.0, ringChance: 0.0, albedo: 0.6, greenhouse: 0.2, tempMin: 0, tempMax: 350 },
        'Mundo facetado': { chance: 0.02, atmoBase: 0.0000, atmoVar: 0.0000, useSystemHue: true, sat: 0.9, lit: 0.60, terrainMods: { octavesAdd: 0, exponentMult: 2.0, heightMult: 1.8 }, aesthetics: { invertLighting: true }, warpBase: 3.0, warpVar: 1.0, radiusMult: 0.85, ringChance: 0.20, albedo: 0.8, greenhouse: 0, tempMin: 0, tempMax: 200 },
        'Planeta de cuarzo': { chance: 0.03, atmoBase: 0.0001, atmoVar: 0.0000, hueBase: 0.85, hueVar: 0.05, sat: 0.7, lit: 0.70, terrainMods: { octavesAdd: -1, exponentMult: 2.2, heightMult: 1.2 }, aesthetics: { globalLerpColor: 0xffccff, globalLerpBase: 0.8, globalLerpLat: 0.2 }, warpBase: 2.0, warpVar: 1.0, radiusMult: 0.8, ringChance: 0.10, albedo: 0.6, greenhouse: 0, tempMin: 0, tempMax: 270 },

        // === MUNDOS SECOS Y DESÉRTICOS ===
        'Planeta desértico': { chance: 0.03, atmoBase: 0.0002, atmoVar: 0.0001, hueBase: 0.10, hueVar: 0.05, sat: 0.6, lit: 0.60, terrainMods: { octavesAdd: -1, exponentMult: 0.9, heightMult: 0.7 }, aesthetics: { hasSand: true, sandColor: 0xddbb55, hasSnow: false }, warpBase: 1.5, warpVar: 1.5, radiusMult: 1.0, ringChance: 0.05, albedo: 0.4, greenhouse: 0.5, tempMin: 260, tempMax: 420 },
        'Mundo de polvo': { chance: 0.03, atmoBase: 0.0006, atmoVar: 0.0002, hueBase: 0.08, hueVar: 0.02, sat: 0.8, lit: 0.40, terrainMods: { octavesAdd: -2, exponentMult: 0.4, heightMult: 0.1 }, aesthetics: { hasSand: true, sandColor: 0xcc8833, hasSnow: false }, warpBase: 0.5, warpVar: 0.5, radiusMult: 1.05, ringChance: 0.15, albedo: 0.3, greenhouse: 1.8, tempMin: 280, tempMax: 450 },
        'Páramo estéril': { chance: 0.03, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.05, hueVar: 0.05, sat: 0.1, lit: 0.40, terrainMods: { octavesAdd: -2, exponentMult: 0.6, heightMult: 0.3 }, aesthetics: { hasSand: false, hasSnow: false }, warpBase: 0.5, warpVar: 0.5, radiusMult: 0.8, ringChance: 0.05, albedo: 0.2, greenhouse: 0, tempMin: 0, tempMax: 300 },
        'Planeta metálico': { chance: 0.02, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.10, hueVar: 0.05, sat: 0.1, lit: 0.60, terrainMods: { octavesAdd: 0, exponentMult: 2.0, heightMult: 1.5 }, aesthetics: { hasSand: false, hasSnow: false }, warpBase: 0.1, warpVar: 0.1, radiusMult: 0.85, ringChance: 0.10, albedo: 0.6, greenhouse: 0, tempMin: 50, tempMax: 400 },
        'Planeta de obsidiana': { chance: 0.03, atmoBase: 0.0001, atmoVar: 0.0001, hueBase: 0.75, hueVar: 0.10, sat: 0.5, lit: 0.10, terrainMods: { octavesAdd: 1, exponentMult: 1.3, heightMult: 1.5 }, aesthetics: { hasSand: false, hasSnow: false }, warpBase: 0.5, warpVar: 1.0, radiusMult: 1.0, ringChance: 0.05, albedo: 0.05, greenhouse: 0.1, tempMin: 300, tempMax: 600 },

        // === MUNDOS EXÓTICOS / BIOLÓGICOS / TÓXICOS ===
        'Ciénaga corrosiva': { chance: 0.03, atmoBase: 0.0005, atmoVar: 0.0003, hueBase: 0.30, hueVar: 0.10, sat: 0.8, lit: 0.40, terrainMods: { octavesAdd: 1, exponentMult: 1.5, heightMult: 0.8 }, aesthetics: { hasSand: true, sandColor: 0xddbb55, hasSnow: false }, warpBase: 2.0, warpVar: 2.5, radiusMult: 1.1, ringChance: 0.10, albedo: 0.2, greenhouse: 3, tempMin: 260, tempMax: 380 },
        'Núcleo expuesto': { chance: 0.04, atmoBase: 0.0005, atmoVar: 0.0002, hueBase: 0.15, hueVar: 0.05, sat: 0.3, lit: 0.30, terrainMods: { octavesAdd: 0, exponentMult: 0.9, heightMult: 0.7 }, aesthetics: { crackLevel: -50, crackColor: 0x33ff11, baseLerpColor: 0x333333, baseLerp: 0.9 }, warpBase: 1.5, warpVar: 1.5, radiusMult: 0.95, ringChance: 0.15, albedo: 0.1, greenhouse: 0.5, tempMin: 400, tempMax: 800 },
        'Mundo bioluminiscente': { chance: 0.02, atmoBase: 0.0002, atmoVar: 0.0001, hueBase: 0.80, hueVar: 0.15, sat: 0.9, lit: 0.30, terrainMods: { octavesAdd: 0, exponentMult: 1.2, heightMult: 1.1 }, aesthetics: { invertLighting: true, waterColor: 0xff00ff }, warpBase: 2.5, warpVar: 1.5, radiusMult: 1.0, ringChance: 0.05, albedo: 0.2, greenhouse: 1.2, tempMin: 240, tempMax: 330 },
        'Planeta de esporas': { chance: 0.02, atmoBase: 0.0004, atmoVar: 0.0002, hueBase: 0.25, hueVar: 0.10, sat: 0.6, lit: 0.30, terrainMods: { octavesAdd: -1, exponentMult: 0.7, heightMult: 0.8 }, aesthetics: { globalLerpColor: 0xaaff55, globalLerpBase: 0.2, globalLerpLat: 0.1 }, warpBase: 2.0, warpVar: 1.0, radiusMult: 0.95, ringChance: 0.0, albedo: 0.3, greenhouse: 1.5, tempMin: 240, tempMax: 340 },
        'Océano carmesí': { chance: 0.03, atmoBase: 0.0003, atmoVar: 0.0001, hueBase: 0.02, hueVar: 0.05, sat: 0.9, lit: 0.20, terrainMods: { octavesAdd: 0, exponentMult: 1.0, heightMult: 0.8 }, aesthetics: { waterLevel: 20, waterColor: 0x880000, beachColor: 0x331111, beachBlend: 0.4 }, warpBase: 1.2, warpVar: 1.5, radiusMult: 1.0, ringChance: 0.05, albedo: 0.2, greenhouse: 1.5, tempMin: 260, tempMax: 380 },
        'Planeta tormentoso': { chance: 0.03, atmoBase: 0.0006, atmoVar: 0.0002, hueBase: 0.60, hueVar: 0.10, sat: 0.3, lit: 0.20, terrainMods: { octavesAdd: 1, exponentMult: 1.1, heightMult: 1.2 }, aesthetics: { hasSand: false, hasSnow: false, waterColor: 0x112233, waterLevel: -20 }, warpBase: 3.0, warpVar: 2.0, radiusMult: 1.05, ringChance: 0.10, albedo: 0.3, greenhouse: 2, tempMin: 250, tempMax: 350 },
        'Mundo crepuscular': { chance: 0.03, atmoBase: 0.0004, atmoVar: 0.0002, hueBase: 0.75, hueVar: 0.15, sat: 0.6, lit: 0.20, terrainMods: { octavesAdd: 0, exponentMult: 1.0, heightMult: 1.0 }, aesthetics: { globalLerpColor: 0x330066, globalLerpBase: 0.5, globalLerpLat: 0.5 }, warpBase: 1.5, warpVar: 1.5, radiusMult: 1.0, ringChance: 0.05, albedo: 0.1, greenhouse: 1, tempMin: 0, tempMax: 300 },
        'Planeta fractal': { chance: 0.03, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.70, hueVar: 0.15, sat: 0.8, lit: 0.40, terrainMods: { octavesAdd: 2, exponentMult: 1.5, heightMult: 1.8 }, aesthetics: { invertLighting: true, globalLerpColor: 0xff00ff, globalLerpBase: 0.2, globalLerpLat: 0.5 }, warpBase: 5.0, warpVar: 3.0, radiusMult: 0.9, ringChance: 0.20, albedo: 0.5, greenhouse: 0, tempMin: 0, tempMax: 200 },

        // === MUNDOS ULTRA RAROS / SCI-FI (1% de chance cada uno) ===
        'Planeta cuántico': { chance: 0.01, atmoBase: 0.0010, atmoVar: 0.0005, useSystemHue: true, sat: 1.0, lit: 0.80, terrainMods: { octavesAdd: -1, exponentMult: 0.5, heightMult: 0.2 }, aesthetics: { invertLighting: true, globalLerpColor: 0xffffff, globalLerpBase: 0.5, globalLerpLat: 0.5 }, warpBase: 10.0, warpVar: 5.0, radiusMult: 0.8, ringChance: 0.50, albedo: 0.9, greenhouse: 0, tempMin: 0, tempMax: 100 },
        'Gigante de materia oscura': { chance: 0.01, isGasGiant: true, hueBase: 0.0, hueVar: 0.0, sat: 0.0, lit: 0.02, warpBase: 1.0, warpVar: 0.5, stretchBase: 1.0, stretchVar: 1.0, radiusMult: 1.5, ringChance: 0.95, albedo: 0, greenhouse: 0, tempMin: 0, tempMax: 50 },
        'Mundo enjambre': { chance: 0.01, atmoBase: 0.0008, atmoVar: 0.0002, hueBase: 0.20, hueVar: 0.05, sat: 0.8, lit: 0.30, terrainMods: { octavesAdd: 3, exponentMult: 1.5, heightMult: 1.2 }, aesthetics: { globalLerpColor: 0x99aa00, globalLerpBase: 0.4, globalLerpLat: 0.0 }, warpBase: 4.0, warpVar: 4.0, radiusMult: 1.1, ringChance: 0.0, albedo: 0.2, greenhouse: 1, tempMin: 250, tempMax: 380 },
        'Planeta de ectoplasma': { chance: 0.01, atmoBase: 0.0015, atmoVar: 0.0005, hueBase: 0.45, hueVar: 0.10, sat: 0.9, lit: 0.60, terrainMods: { octavesAdd: -2, exponentMult: 0.8, heightMult: 0.3 }, aesthetics: { waterLevel: 50, waterColor: 0x00ffaa, invertLighting: true }, warpBase: 1.0, warpVar: 1.0, radiusMult: 1.05, ringChance: 0.10, albedo: 0.4, greenhouse: 1.5, tempMin: 200, tempMax: 300 },
        'Fragmento de estrella': { chance: 0.01, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.10, hueVar: 0.05, sat: 1.0, lit: 0.90, terrainMods: { octavesAdd: 1, exponentMult: 1.0, heightMult: 1.0 }, aesthetics: { crackLevel: -200, crackColor: 0xffffff, baseLerpColor: 0xffaa00, baseLerp: 0.8 }, warpBase: 5.0, warpVar: 2.0, radiusMult: 0.7, ringChance: 0.0, albedo: 0.1, greenhouse: 0, tempMin: 1000, tempMax: 9999 },
        'Mundo reloj': { chance: 0.01, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.12, hueVar: 0.02, sat: 0.3, lit: 0.50, terrainMods: { octavesAdd: -3, exponentMult: 5.0, heightMult: 0.5 }, aesthetics: { hasSand: false, hasSnow: false }, warpBase: 0.0, warpVar: 0.0, radiusMult: 1.0, ringChance: 0.80, albedo: 0.5, greenhouse: 0, tempMin: 200, tempMax: 350 },
        'Planeta espejo': { chance: 0.01, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.0, hueVar: 0.0, sat: 0.0, lit: 0.80, terrainMods: { octavesAdd: -2, exponentMult: 0.5, heightMult: 0.2 }, aesthetics: { waterLevel: 20, waterColor: 0xffffff }, warpBase: 0.1, warpVar: 0.1, radiusMult: 0.9, ringChance: 0.0, albedo: 0.99, greenhouse: 0, tempMin: 10, tempMax: 400 },
        'Planeta de antimateria': { chance: 0.01, atmoBase: 0.0005, atmoVar: 0.0005, hueBase: 0.80, hueVar: 0.20, sat: 1.0, lit: 0.50, terrainMods: { octavesAdd: 1, exponentMult: 1.2, heightMult: 1.5 }, aesthetics: { invertLighting: true, globalLerpColor: 0x000000, globalLerpBase: 0.5, globalLerpLat: 0.5 }, warpBase: 3.0, warpVar: 3.0, radiusMult: 0.95, ringChance: 0.30, albedo: 0, greenhouse: 0.5, tempMin: 50, tempMax: 150 },
        'Gigante lenticular': { chance: 0.01, isGasGiant: true, hueBase: 0.08, hueVar: 0.05, sat: 0.5, lit: 0.40, warpBase: 1.0, warpVar: 1.0, stretchBase: 15.0, stretchVar: 5.0, radiusMult: 1.3, ringChance: 1.0, albedo: 0.5, greenhouse: 0.5, tempMin: 50, tempMax: 250 },
        'Planeta prisma': { chance: 0.01, atmoBase: 0.0, atmoVar: 0.0, useSystemHue: true, sat: 1.0, lit: 0.5, terrainMods: { octavesAdd: 0, exponentMult: 2.0, heightMult: 1.0 }, aesthetics: { globalLerpColor: 0xffffff, globalLerpLat: 1.0 }, warpBase: 10.0, warpVar: 2.0, radiusMult: 1.0, ringChance: 0.0, albedo: 0.8, greenhouse: 0, tempMin: 50, tempMax: 350 },

        // === COMODÍN ===
        // Suma de los 39 planetas anteriores = 0.96. Esto deja un ~0.04 (4%) de probabilidad para el clásico planeta rocoso.
        'Planeta rocoso': { chance: 0.04, atmoChance: 0.3, atmoBase: 0.00005, atmoVar: 0.00045, useSystemHue: true, satRandomBase: 0.2, satRandomMult: 0.4, litRandomBase: 0.2, litRandomMult: 0.5, terrainMods: { octavesAdd: 0, exponentMult: 1.0, heightMult: 1.0 }, aesthetics: { hasSand: true, sandColor: 0xddbb55, hasSnow: true }, warpBase: 1.0, warpVar: 1.5, radiusMult: 1.0, ringChance: 0.10, albedo: 0.3, greenhouse: 0.8, tempMin: 100, tempMax: 500 }
    },
    ...
    BLACK_HOLE_BASE_RADIUS_VAR: 100.0, // Variación del radio base antes de multiplicadores
    ...
    KEYS: {
        ...
        BRAKE: ['Space'],
        VERTICAL_UP_BTN: 4, // Mouse button 4 (Forward)
        VERTICAL_DOWN_BTN: 3, // Mouse button 3 (Back)
    ...
    // ==========================================
    RENDER_FOV: 60, // Campo de visión de la cámara (Grados)
    ...
    // ==========================================
    UI_MAX_LABELS: 10, // Máximo de etiquetas de nombres mostrándose al mismo tiempo
    UI_LABEL_MAX_DISTANCE: 100000000, // Distancia máxima base (u) a la que ves el nombre de un planeta/estrella
    UI_LABEL_DISTANCE_MULT: 1000, // Multiplicador del radio para ver el label a mayor distancia si es un gigante
