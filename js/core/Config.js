export const Config = {
    ...
    PLANET_BIOMES: {
        ...
        'Gigante helado': { chance: 0.03, isGasGiant: true, hueBase: 0.55, hueVar: 0.10, sat: 0.6, lit: 0.6, warpBase: 2.0, warpVar: 2.0, stretchBase: 1.5, stretchVar: 2.0, radiusMult: 0.8, ringChance: 0.90, albedo: 0.6, greenhouse: 0.5, tempMin: 20, tempMax: 150 },
        ...
        'Gigante de silicato': { chance: 0.04, isGasGiant: true, hueBase: 0.05, hueVar: 0.02, sat: 0.1, lit: 0.70, warpBase: 5.0, warpVar: 3.0, stretchBase: 5.0, stretchVar: 6.0, radiusMult: 1.1, ringChance: 0.60, albedo: 0.3, greenhouse: 3, tempMin: 800, tempMax: 2500 },
        'Júpiter caliente': { chance: 0.02, isGasGiant: true, hueBase: 0.02, hueVar: 0.05, sat: 0.8, lit: 0.3, warpBase: 6.0, warpVar: 4.0, stretchBase: 2.0, stretchVar: 2.0, radiusMult: 1.5, ringChance: 0.10, albedo: 0.1, greenhouse: 2.5, tempMin: 600, tempMax: 2000 },
        ...
        'Páramo estéril': { chance: 0.03, atmoBase: 0.0000, atmoVar: 0.0000, hueBase: 0.05, hueVar: 0.05, sat: 0.1, lit: 0.40, terrainMods: { octavesAdd: -2, exponentMult: 0.6, heightMult: 0.3 }, aesthetics: { hasSand: false, hasSnow: false }, warpBase: 0.5, warpVar: 0.5, radiusMult: 0.8, ringChance: 0.05, albedo: 0.2, greenhouse: 0, tempMin: 200, tempMax: 300 },
